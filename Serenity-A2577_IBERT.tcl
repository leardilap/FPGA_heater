...
#
# Serenity-A2577_IBERT.tcl: Tcl script for re-creating project 'Serenity-A2577_IBERT'
#
# Generated by Vivado on Fri Jan 08 20:14:05 CET 2021
...
#
# 1. This project restoration tcl script (Serenity-A2577_IBERT.tcl) that was generated.
#
...
#
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/ip/vio_0/vio_0.xci"
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/ip/IBERT_MGT_16G_25G/IBERT_MGT_16G_25G.xci"
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/src/heater/lut_oscilator.vhd"
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/src/heater/heater.vhd"
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/src/example_IBERT_MGT_16G_25G.v"
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/constr/example_IBERT_MGT_16G_25G.xdc"
#    "/home/lardilap/Projects/Serenity-A2577/ibert/test_build/serenity-a2577_ibert/constr/ibert_ultrascale_gty_ip_example.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "Serenity-A2577_IBERT"
...
set script_file "Serenity-A2577_IBERT.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/Serenity-A2577_IBERT"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xcvu9p-flga2577-2-e
...
set_property -name "part" -value "xcvu9p-flga2577-2-e" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/ip/IBERT_MGT_16G_25G/IBERT_MGT_16G_25G.xci"] \
 [file normalize "${origin_dir}/src/heater/lut_oscilator.vhd"] \
 [file normalize "${origin_dir}/src/heater/heater.vhd"] \
 [file normalize "${origin_dir}/src/example_IBERT_MGT_16G_25G.v"] \
]
...
set file "$origin_dir/ip/IBERT_MGT_16G_25G/IBERT_MGT_16G_25G.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set file "$origin_dir/src/heater/lut_oscilator.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/heater/heater.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "example_IBERT_MGT_16G_25G" -objects $obj
...
set file "[file normalize "$origin_dir/constr/example_IBERT_MGT_16G_25G.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/example_IBERT_MGT_16G_25G.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constr/ibert_ultrascale_gty_ip_example.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/ibert_ultrascale_gty_ip_example.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xcvu9p-flga2577-2-e" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvu9p-flga2577-2-e -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu9p-flga2577-2-e -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
